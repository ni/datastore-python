...
def test___init___with_values() -> None:
    ...
    moniker = Moniker(
        service_location="localhost:8080",
...
def test___init___with_keyword_arguments() -> None:
    ...
    moniker = Moniker(
        data_instance=123,
        service_location="example.com:9090",
...
def test___from_protobuf___creates_instance_from_protobuf() -> None:
    ...
    proto = MonikerProto(
        service_location="proto.server:8080",
        data_source="proto_source",
        data_instance=789
    )
...
def test___to_protobuf___converts_to_protobuf_message() -> None:
    ...
    moniker = Moniker(
        service_location="test.service:443",
...
def test___round_trip_conversion___preserves_values() -> None:
    ...
    original = Moniker(
        service_location="roundtrip.test:8080",
        data_source="roundtrip_source",
        data_instance=999
    )
...
def test___equality___same_values() -> None:
    ...
    moniker1 = Moniker(
        service_location="same.server:8080",
...
def test___str___returns_protobuf_string() -> None:
    ...
    moniker = Moniker(
        service_location="str.test:8080",
        data_source="str_source",
        data_instance=777
    )
