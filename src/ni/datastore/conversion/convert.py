...
from ni.datastore.conversion.convert import Converter
from ni.datastore.conversion.builtin import (
    BoolConverter,
    BytesConverter,
    DTDateTimeConverter,
...
from ni.datastore.conversion.protobuf_types import (
    BTDateTimeConverter,
...
def to_protobuf_message(python_value: object) -> Message:
    """Convert a Python object to a protobuf Any."""
    best_matching_type = _get_best_matching_type(python_value)
    converter = _CONVERTER_FOR_PYTHON_TYPE[best_matching_type]
    return converter.to_protobuf_message(python_value)
